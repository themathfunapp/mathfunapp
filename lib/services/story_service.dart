...
class StoryService extends ChangeNotifier {
  ...
  List<StoryWorld> _generatePreschoolWorlds() {
    return [
      StoryWorld(
        id: 'number_forest_preschool',
        theme: WorldTheme.numberForest,
        nameKey: 'world_number_forest',
        descriptionKey: 'world_number_forest_desc',
        iconEmoji: '🌲',
        colors: ['#4CAF50', '#8BC34A'],
        topics: [MathTopic.counting, MathTopic.addition],
  ...
  List<StoryWorld> _generateEarlyElementaryWorlds() {
    return [
      StoryWorld(
        ...
        theme: WorldTheme.numberForest,
        nameKey: 'world_number_forest',
        descriptionKey: 'world_number_forest_desc_early',
        iconEmoji: '🌲',
        colors: ['#4CAF50', '#8BC34A'],
