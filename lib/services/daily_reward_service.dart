...
class DailyRewardService extends ChangeNotifier {
  ...
  static const List<DailyTask> dailyTasks = [
    ...
    DailyTask(
      id: 'world_map_visit',
      titleKey: 'task_world_map_visit',
      descriptionKey: 'task_world_map_visit_desc',
      emoji: '🗺️',
      type: TaskType.visitWorldMap,
      targetValue: 1,
      rewards: [RewardItem(type: RewardType.coins, amount: 10, emoji: '🪙')],
      difficulty: TaskDifficulty.easy,
    ),
    // Zeka oyunları görevleri
    DailyTask(
      id: 'brain_play_2',
      titleKey: 'task_brain_play_2',
      descriptionKey: 'task_brain_play_2_desc',
      emoji: '🧠',
      type: TaskType.playBrainGame,
      targetValue: 2,
      rewards: [RewardItem(type: RewardType.coins, amount: 10, emoji: '🪙')],
      difficulty: TaskDifficulty.easy,
    ),
    DailyTask(
      id: 'color_math_steps_5',
      titleKey: 'task_color_math_steps_5',
      descriptionKey: 'task_color_math_steps_5_desc',
      emoji: '🎨',
      type: TaskType.playColorMathStep,
      targetValue: 5,
      rewards: [RewardItem(type: RewardType.coins, amount: 10, emoji: '🪙')],
      difficulty: TaskDifficulty.easy,
    ),
    ...
    DailyTask(
      id: 'simon_level_8',
      titleKey: 'task_simon_level_8',
      descriptionKey: 'task_simon_level_8_desc',
      emoji: '🎯',
      type: TaskType.simonReachLevel8,
      targetValue: 1,
      rewards: [RewardItem(type: RewardType.coins, amount: 15, emoji: '🪙')],
      difficulty: TaskDifficulty.medium,
    ),
    DailyTask(
      id: 'memory_under_60',
      titleKey: 'task_memory_under_60',
      descriptionKey: 'task_memory_under_60_desc',
      emoji: '🃏',
      type: TaskType.memoryUnder60s,
      targetValue: 1,
      rewards: [RewardItem(type: RewardType.coins, amount: 12, emoji: '🪙')],
      difficulty: TaskDifficulty.medium,
    ),
    DailyTask(
      id: 'color_math_complete_1',
      titleKey: 'task_color_math_complete_1',
      descriptionKey: 'task_color_math_complete_1_desc',
      emoji: '🏆',
      type: TaskType.completeColorMath,
      targetValue: 1,
      rewards: [RewardItem(type: RewardType.coins, amount: 15, emoji: '🪙')],
      difficulty: TaskDifficulty.medium,
    ),
